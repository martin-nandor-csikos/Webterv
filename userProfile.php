...
<body>
    <header id="indexHeader">
        ...
        <nav id="menuBar">
            ...
            <a style="padding-left: 60px; padding-right: 60px;" href="userProfile.php" id="" class="active">Adatlap</a>
    ...
    <h1 class="title">Adatlap</h1>
    <?php require_once "./php/viewOwnProfile.php" ?>
